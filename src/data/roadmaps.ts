...
---`,
  ...
  },
  {
    ...
    exerciceCorporel: `Quand l'envie de partir monte, portez votre attention sur les pieds au sol. Sentez le poids du corps sur la plante des pieds. Le contact avec le sol est l'ancre. Sylvie a appris cet exercice avant tout le reste.
...
---`,
  ...
  },
  {
    ...
    exerciceCorporel: `Quand l'autre se rapproche (physiquement ou émotionnellement), portez votre attention sur la poitrine. Sentez ce qui s'y passe. Une oppression ? Une chaleur ? Une fermeture ? Vous restez 30 secondes en observation. Sylvie a fait ce travail-là pendant des mois.
...
---`,
  ...
  },
  {
    ...
    pasNumeroTrois: `Engagez le programme Régénération en présentiel. À ce niveau d'isolement, le corps a besoin du groupe, de la chaleur d'autres présences, et d'un cadre où la fuite n'est pas une option immédiate. C'est exactement ce que Sylvie a fait après ses 18 mois d'absence.`,
