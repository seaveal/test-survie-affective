...
Vous performez, vous excellez, vous séduisez. Votre stratégie tient en une phrase : si je suis irréprochable, on ne m'abandonnera pas. Si je brille assez fort, on me gardera. Alors vous en donnez toujours plus, et vous accumulez au-dehors les preuves d'une valeur que vous ne sentez pas au-dedans.
...
Votre valeur ne dépend pas de votre utilité. Mais votre corps ne l'a jamais appris. Il peut l'apprendre.`,
    ...
    modulateursIntensite: {
      ...
      modere: `Le schéma Sauveur structure désormais une grande partie de votre vie. Vous donnez par réflexe, sans même réaliser que vous le faites. La fatigue est chronique. Vous prenez en charge plusieurs personnes à bout de bras, et personne ne prend soin de la vôtre. Vous montez les escaliers de votre propre maison comme à soixante-dix ans. Le moment est venu de mettre des mots et un cadre sur ce qui se joue, parce que la spirale s'accélère.`,
...
Vous fuyez. Que ça devienne sérieux, vous étouffez. Que l'autre s'approche, vous reculez. Votre stratégie : partir en premier, pour que l'abandon, au moins, vienne de vous. Ce n'est pas une liberté. C'est une prison, celle de la fuite. Le corps présent, l'âme absente, vous vivez derrière une vitre. Les gens ne se fâchent pas avec vous. Ils s'usent. Ils frappent contre le verre un moment, poliment, et puis ils passent leur chemin.
...
Voici ce que personne ne vous a jamais dit. Vous n'avez jamais posé de limite de votre vie. Vous avez posé des absences. Vous partez avant d'avoir à dire non, vous vous effacez avant qu'on vous refuse, et le coût, c'est que vous n'apparaissez jamais vraiment, dans aucune relation. Vous restez au seuil de votre propre vie. Un bunker, ça marche. On y survit à tout, sauf à la vie.`,
    septSymptomes: [
      ...
      `**L'auto-effacement.** Le symptôme central de votre profil. Vous vivez à travers une vitre, à regarder une vie qui semble arriver à quelqu'un d'autre.`,
