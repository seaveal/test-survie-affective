...
> **Note 2026-07-17 (réécriture profils, session Claude-Code)** : les 4 descriptions de base, les 4 interdictions dominantes, les 28 symptômes et les 12 modulateurs ont été réécrits pour être plus complets, précis, viscéraux, immersifs et conversationnels, à partir de toute la matière consolidée depuis 2026-06 (avatars-material, avatars-questions, fiches archétypes normatives, nurturing-livre validé, livre ch02). Structure de parsing inchangée (mêmes titres de sections, 7 symptômes, 3 modulateurs par profil). Voix : 0 tiret cadratin, 0 point-virgule, vouvoiement, R12 (coaching non-clinique), lexique corporel à rotation par zone, calques bannis (porter/tenir/vider/serrer transitif). Ambassadeurs canoniques Emeric / Hélène / Virginie / Pascale.

---

> **Note 2026-07-10 (correction ambassadeurs, validée Cyrille en session)** : les prénoms d'ambassadeurs périmés (Vincent / Damien / Sébastien / Sylvie, antérieurs à la décision 2026-05-29) ont été remplacés par les canoniques **Emeric / Hélène / Virginie / Pascale**. Source de vérité : `40-Knowledge/Pro/PHM/Ambassadeurs-J7-canoniques.md`. Fiches archétypes complètes : `40-Knowledge/Pro/PHM/Archetypes/`.

---

> **Note 2026-05-28, sous-sections "Interdiction dominante" (RÉSERVÉES EMAIL POST-TEST, NE PAS RÉGÉNÉRER DANS src/data)** :
>
> Chacun des 4 profils a une sous-section `## Interdiction dominante` (entre la description de base et les 7 symptômes). Ces textes sont **destinés EXCLUSIVEMENT à la séquence email post-test segmentée par profil**, pas à la page de résultat web.
>
> Mapping. Mendiant → décevoir. Sauveur → prendre de la place. Contrôleur → ressentir. Fantôme → poser une limite. Formule canonique : « **Vous ne vous autorisez pas à [verbe]** ».
>
> **NE PAS RÉGÉNÉRER `src/data/profils.ts` DEPUIS CE FICHIER tant que `scripts/parse_profils.py` n'a pas été adapté** pour skipper la sous-section `## Interdiction dominante`. Le composant `ResultLevel1.tsx` reste donc identique et la page web ne montre pas l'interdiction.
...
Vous brillez. Et vous vous sentez vide.
...
## Interdiction dominante

**Vous ne vous autorisez pas à décevoir.**

Très tôt, vous avez appris que pour être aimé, il fallait être à la hauteur. Performer. Briller. Ne jamais laisser voir la faille. Aujourd'hui encore, l'idée de décevoir quelqu'un déclenche une alarme dans le ventre. Alors vous compensez. Vous donnez plus. Vous faites mieux. Vous ne dites pas non. Et la mécanique se referme comme une phrase que vous n'avez jamais osé dire à voix haute : demander, c'est avouer, avouer, c'est décevoir, décevoir, c'est mourir un peu. Alors vous faites tout, tout seul, avec le sourire. Et vous vous épuisez à mériter ce qui devrait être donné.

## Les 7 symptômes (Mendiant, communs aux 3 intensités)

1. **La quête de regard.** Vous mesurez votre valeur au nombre de têtes qui se tournent quand vous entrez dans une pièce. Le regard des autres n'est pas un plaisir, c'est votre oxygène.

2. **La honte de soi.** Quand le regard manque, l'effondrement est immédiat, comme si vous n'existiez plus. Et un mot que vous n'osez pas dire attend en dessous : imposteur. Chaque réussite repousse d'un jour le moment où l'on vous démasquera.

...
**Ambassadrice** : Virginie

## Description de base

Plus vous contrôlez, plus vous avez peur.
...
**Vous ne vous autorisez pas à ressentir.**

Ressentir, c'est lâcher prise. Et lâcher prise, c'est risquer que tout s'effondre. Alors vous rationalisez. Vous comprenez. Vous analysez. Vous verrouillez les choses pour qu'elles ne glissent pas. Le problème, c'est que vos émotions ne disparaissent pas, elles s'enkystent. Et quand elles débordent, elles débordent au mauvais moment, avec une violence qui vous étonne vous-même. La solidité qui se crispe est une armure. La solidité qui se relâche est une colonne vertébrale. Tout le reste en découle.

## Les 7 symptômes (Contrôleur)

1. **La quête de regard.** Vous scrutez en permanence le moindre signe de désengagement chez l'autre. Un silence, un message plus tardif, un ton qui change, et l'alerte monte.

2. **La honte de soi.** Quand vous perdez le contrôle, vous vous sentez vulnérable, exposé, indigne. La honte se loge dans la poitrine, épaisse, et les excuses ne la délogent pas.
...
4. **L'incompréhension.** Vous expliquez et ré-expliquez, avec des récapitulatifs et des pièces jointes, et l'autre ne comprend toujours pas. C'est insupportable.

5. **L'auto-effacement.** Sous l'agressivité du contrôle, il y a un enfant terrifié qui n'existe que dans la maîtrise. On vous dit carré, fiable. C'est le compliment qu'on vous fait depuis vingt ans, et c'est une laisse.

6. **La perte de contrôle.** Le symptôme central. Vous gérez tout, et tout vous échappe en permanence. Plus la main se referme, plus tout file entre les doigts.

7. **L'incapacité à s'affirmer.** Soit vous attaquez, soit vous explosez. Vous ne savez pas dire « j'ai peur » ou « j'ai besoin de toi » sans hostilité. C'est le corps qui l'interdit.

## Modulateurs d'intensité (Contrôleur)

### Intensité SURFACE

Le schéma Contrôleur s'invite dans votre vie, sans encore avoir étouffé vos relations. Vous savez que vous verrouillez parfois trop fort, et vous savez vous reprendre. L'anxiété est là, mais récupérable. C'est le bon moment pour comprendre d'où elle vient, avant qu'elle ne s'incruste plus profondément dans le corps.
...
Vous partez avant qu'on vous quitte.
...
**Vous ne vous autorisez pas à poser une limite.**

Poser une limite, c'est risquer le conflit. Risquer le conflit, c'est risquer l'abandon. Alors vous avez trouvé une autre voie. Vous partez avant. Vous vous effacez. Vous disparaissez avant d'avoir à dire non. Le coût, c'est que vous n'apparaissez jamais vraiment, dans aucune relation. Et si votre corps a été assez compétent pour apprendre à partir, à lire un visage, à repérer chaque sortie, alors rien ne l'empêche d'apprendre à rester.
...
3. **La comparaison toxique.** Tous les autres semblent savoir comment être en relation. Vous, non. Et vous vous comparez encore, et vous perdez encore.

4. **L'incompréhension.** Vous avez arrêté d'essayer de vous faire comprendre. De toute façon, ça ne sert à rien.

5. **L'auto-effacement.** Le symptôme central de votre profil. Vous vivez à travers une vitre, spectateur d'une vie qui semble arriver à quelqu'un d'autre.
