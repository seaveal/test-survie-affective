...
Vous performez, vous excellez, vous séduisez. Votre stratégie se résume en une phrase : si je suis irréprochable, on ne m'abandonnera pas. Si je brille assez fort, on me gardera. Alors vous en donnez toujours plus, et vous accumulez au-dehors les preuves d'une valeur que vous ne sentez pas au-dedans.
...
Regardez votre corps au moment exact où quelqu'un vous fait un compliment ou un cadeau. La gorge se ferme. Le ventre se creuse, comme un trou d'air. Recevoir, pour vous, n'est pas un plaisir. C'est un effort qui échoue.

Cet interdit a un âge. Dans votre enfance, une information s'est inscrite, définitive : je ne mérite pas. Pas de recevoir, pas qu'on vous aide, pas qu'on vous aime pour ce que vous êtes, seulement pour ce que vous produisez. Un mot a suffi. Un « et ça ? » posé sur la seule note qui ne dépassait pas, sur un bulletin par ailleurs parfait. Un « je compte sur toi » déposé un matin sur les épaules d'un enfant trop jeune. L'enfant n'a pas conclu « on ne m'aime pas ». Il a conclu « je sais comment faire revenir l'attention ». Et il a fait. Encore. Plus fort. Mieux. Vous faites toujours.
...
Comprendre tout cela n'a rien ouvert. Le blocage vient de l'intérieur, et ce qui le lève n'est pas dans la tête. Recevoir reste votre seul interdit. L'amour ne se mérite pas. Il se reçoit. Et recevoir, c'est le seul geste que votre corps n'a jamais appris.`,
    septSymptomes: [
      ...
      `**L'incompréhension.** Vous brillez fort, mais personne ne voit qui vous êtes au fond. Vous avez tout fait pour qu'on ne vous croie pas. Alors vous avez fini par ne plus essayer, dans la solitude, au milieu de gens qui vous aiment.`,
      ...
      `**L'incapacité à s'affirmer.** Vous brillez ou vous explosez. Vous ne savez pas dire calmement « j'ai besoin d'aide » ou « ça ne me va pas ». L'alarme dans le ventre parle avant vous.`,
    ],
...
Et le don sans retour appelle son contraire avec une régularité mécanique. Celui qui donne sans compter attire toujours celui qui prend sans rendre. Alors ils viennent poser leurs problèmes sur votre table et repartent soulagés, et vous absorbez. « Toi ça va, tu gères. » « Qu'est-ce qu'on ferait sans toi. » Ce n'est pas un merci, c'est un contrat. Vous voilà le mur porteur, et on ne demande pas à un mur porteur s'il est fatigué.

Cette place a un âge. Un parent émotionnellement absent, une enfance entière passée à tenter de le rendre heureux, un enfant de huit ans qui faisait déjà le café pour exister dans la pièce. Vous avez appris que l'amour se gagne en se rendant indispensable, et vous avez disparu sous les besoins des autres sans que personne ne s'en aperçoive. Personne n’est parti à votre recherche. Vous aviez tout organisé pour ne jamais peser.

Si vous avez derrière vous des années d'approches verbales en cabinet à comprendre tout cela, vous continuez quand même. Car le Sauveur Épuisé est un mendiant déguisé en héros. Il donne pour recevoir. Et le jour où il n'a plus rien à donner, il se retrouve seul avec sa propre tristesse, celle qu'il a prise en charge pour tous, sauf pour lui.

Votre valeur ne dépend pas de votre utilité. Mais votre corps ne l'a jamais appris. Il peut l'apprendre.`,
    septSymptomes: [
      `**La quête de regard.** Vous cherchez à ce qu’on vous voie d’un bon œil, qu’on vous considère, qu’on vous reconnaisse pour tout ce que vous faites pour les autres. Jamais pour ce que vous êtes quand vous ne faites rien.`,
      ...
      `**La perte de contrôle.** Quand quelqu'un que vous avez sauvé vous lâche ou vous trahit, tout s'effondre d'un coup. La colère qui déborde alors est la colère de toutes les fois où vous n’avez rien dit.`,
...
Vous surveillez, vous anticipez, vous vérifiez. Votre stratégie se résume à un réflexe : tout prévoir pour que rien ne vous surprenne. Sauf que le contrôle est un cercle, et il se referme sur vous. Plus vous contrôlez, plus la peur monte. Plus la peur monte, plus vous contrôlez. Le contrôle promet la sécurité. Il n'offre que la surveillance.

Il est 23h41 et vous relisez un mail envoyé à 18h02. Trois fois. Vous cherchez la phrase qui pourrait être mal comprise, vous la trouvez, et le ventre se noue sur un message que rien ne peut plus rattraper. À 3h03, vous vous réveillez, la nuque en béton, le cerveau qui ouvre les dossiers un par un et déroule chaque scénario jusqu'au pire. Prévoir la catastrophe ne l'a jamais empêchée. Ça vous use en l'attendant.
...
Vous vous croyez victime de ce qui vous arrive. La réalité est plus dure à encaisser. Vous scannez le moindre signe de désengagement chez l'autre, et ce scan fabrique exactement le désengagement que vous redoutez. L’autre pose sa fourchette au milieu du dîner et dit « je ne suis pas un dossier ». Pour ne pas subir l'abandon, vous devenez l'agresseur que vous fuyez, bourreau et victime dans le même corps, par le même geste. Le triangle se referme sur vous. Et voilà des années que vous tournez dedans sans en voir les murs.`,
    septSymptomes: [
      ...
      `**La honte de soi.** Quand vous perdez le contrôle, vous vous sentez vulnérable, à nu, indigne. La honte se loge dans la poitrine, épaisse, et les excuses ne la délogent pas.`,
      ...
      `**L'auto-effacement.** Sous l'agressivité du contrôle, il y a un enfant terrifié qui n'existe que dans la maîtrise. On vante votre rigueur, votre fiabilité. C'est le compliment qu'on vous fait depuis vingt ans, et c'est une laisse.`,
    ...
    modulateursIntensite: {
      ...
      profond: `Le schéma Contrôleur a pris la commande de votre vie entière. L'anxiété est permanente, le corps est en alerte rouge depuis trop longtemps, le sommeil ne vous répare plus. Vos relations ont commencé à s'user autour de vous, les gens répondent au lieu de raconter. Cette intensité demande un travail corporel encadré, parce que la pensée seule ne désarme pas le système nerveux. La tête comprend. Le corps répare.`,
    },
  },
  {
    id: 'fantome',
...
Vous fuyez. Que ça devienne sérieux, vous étouffez. Que l'autre s'approche, vous reculez. Votre stratégie : partir en premier, pour que l'abandon, au moins, vienne de vous. Vous appelez cela une liberté. C'est une prison, celle de la fuite. Le corps présent, l'âme absente. Les gens ne se fâchent pas avec vous. Ils s'usent. Ils insistent un moment, poliment, et puis ils passent leur chemin.
...
Il y a deux façons de fuir, et vous en connaissez au moins une. Vous quittez quelqu'un un matin et vous vous retrouvez en couple le soir même, avec un autre, parce que rester sans personne, ne serait-ce qu'une nuit, vous terrorise. Le Fantôme ne fuit pas une personne. Il fuit ce qu'il ressent quand il se retrouve seul avec lui-même. Ou bien vous restez, avec des partenaires qui vous rabaissent, qui vous font souffrir, et vous restez quand même. Pour quelle bonne raison ? Parce que vous y gagnez un avantage, en secret. Souvent, celui de rester à hauteur d’enfant. De ne pas grandir. De ne pas déranger un parent ancien qui n'aurait pas supporté votre élan.

Enfant, vous avez appris à lire le visage d'un parent avant d'apprendre à lire les mots, pour savoir si l'orage arrivait. Prendre de la place, c'était risquer de perdre l'amour. Alors vous avez choisi, sans le savoir, des liens qui vous maintiennent à l’étroit. Et vous avez fini par confondre le calme et la paix, le retrait et la solidité, l'absence de conflit et l'harmonie. Vous croyez que vous taire protège la relation. Votre silence la détruit.
...
Voici ce que personne ne vous a jamais dit. Vous n'avez jamais posé de limite de votre vie. Vous avez posé des absences. Vous partez avant d'avoir à dire non, vous vous effacez avant qu'on vous refuse, et le coût, c'est que vous n'apparaissez jamais vraiment, dans aucune relation. Vous restez au seuil de votre propre vie. Un bunker, ça marche. On y survit à tout, sauf à la vie.`,
    septSymptomes: [
      `**La quête de regard.** Vous le fuyez et vous le cherchez en même temps. Vous voulez qu’on vous voie sans vous montrer.`,
      ...
      `**L'auto-effacement.** Le symptôme central de votre profil. Vous vivez à distance, à regarder une vie qui semble arriver à quelqu'un d'autre.`,
    ...
    modulateursIntensite: {
      ...
      modere: `Le schéma Fantôme structure une grande partie de vos relations. Vous savez que vous fuyez, vous le voyez, et vous n'arrivez plus à vous arrêter. L'isolement s'installe doucement. La sensation d'assister à votre vie devient familière. Le moment est venu de regarder en face d'où vient cette impulsion à disparaître, parce qu'elle vous coupe désormais de votre propre vie.`,
      profond: `Le schéma Fantôme a pris toute la place. Vous avez sans doute déjà tout fui, plusieurs fois. La solitude dure depuis longtemps, ou votre corps est là, dans une relation où votre âme s'est absentée, en colocation dans votre propre couple. La sensation d'être un fantôme dans votre propre vie est devenue permanente. Cette intensité demande un travail corporel encadré, parce qu'à ce stade, c'est au corps d'apprendre à rester. Pascale a été là. Elle s'effaçait depuis toujours. Une fois, elle est restée. Tout est parti de là. Votre vie peut changer aussi.`,
    },
  },
]
